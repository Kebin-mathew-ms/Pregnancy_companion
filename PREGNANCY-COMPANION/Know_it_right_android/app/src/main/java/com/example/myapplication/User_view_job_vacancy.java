...
public class User_view_job_vacancy extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {

    ListView l1;
    String[] job_vacancy_id,job_category_id,company_id,job_title,job_description,skills,job_category_name,company_name,val;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_view_job_vacancy);
        ...
        jr.json_response=(JsonResponse)User_view_job_vacancy.this;
        String q="User_view_job_vacancy?login_id="+sh.getString("login_id","");
        jr.execute(q);
    ...
    public void response(JSONObject jo) {
        ...
        try
        {
            ...
            if(method.equalsIgnoreCase("User_view_job_vacancy")){
...
//                    l1.setAdapter(new ArrayAdapter<String>(getApplicationContext(), R.layout.cust_complaints,val));
                    ...
                    Cust_job_vacancy cc=new Cust_job_vacancy(this,job_title,company_name,job_description);
                    l1.setAdapter(cc);
...
//
        ...
        ed.putString("back", "User_view_job_vacancy");
        ed.commit();
